...
<div class="container allNews">
  <div class="single-post">
     <div class="feature-img">
        <img class="feature-img-img" src="{{ asset('img/santri/'.$video -> sampul) }}" alt="">
     </div>
     <div class="blog_details">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <form id="layakDitayangkan" action="{{ route('all.store.detail.santri',$video -> judul) }}" method="POST" style="display: none;">
              @csrf
            </form>
          </div>
          <div class="col-lg-6">
            ...
            <form id="tidakLayakDitayangkan" action="{{ route('all.store.tidakSetuju.detail.santri',$video -> judul) }}" method="POST" style="display: none;">
              @csrf
            </form>
          </div>
        </div>
