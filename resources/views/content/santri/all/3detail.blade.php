     ...
     <div class="blog_details">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <form id="layakDitayangkan" action="{{ route('all.store.detail.santri',$santri -> id) }}" method="POST" style="display: none;">
              @csrf
            </form>
          </div>
          <div class="col-lg-6">
            ...
            <form id="tidakLayakDitayangkan" action="{{ route('all.store.tidakSetuju.detail.santri',$santri -> id) }}" method="POST" style="display: none;">
              @csrf
            </form>
          </div>
        </div>
